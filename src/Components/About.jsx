                ...
                <div className="w-1/3 text-gray-600">
                    ...
                    <div className="">
                        <Link to="https://drive.usercontent.google.com/u/0/uc?id=1UCBn4cAIHq4R_C99IeuHKGrpGSptVuvn&export=download">
                            <button className="px-4 py-3 text-white bg-[#00a1ea] hover:bg-gray-200 hover:text-gray-700 hover:opacity-90 rounded-xl transition duration-300 ease-in-out">Download Resume</button>
                        </Link>
                    </div>
                </div>
            </div>
